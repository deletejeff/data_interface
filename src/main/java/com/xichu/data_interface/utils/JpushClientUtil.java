...
public class JpushClientUtil {
    private final static String APPKER = "74f736412481b19045b7b476";
    private final static String MASTERSECRET = "329333650e60939f8dabfba4";
...
//        sendToAll("测试", "测试信息", "测试信息", "https://www.baidu.com");
     ...
     * @return 0推送失败，1推送成功
     */
    public static int sendToRegistrationIdByTime(List<String> alias, String notification_title, String msg_title, String msg_content, String extrasparam, String time) {
        JPushClient jPushClient = new JPushClient(MASTERSECRET, APPKER);
        int result = 0;
        try {
            PushPayload pushPayload = JpushClientUtil.buildPushObject_all_alias_alertWithTitle(alias, notification_title, msg_title, msg_content, extrasparam);
            ScheduleResult scheduleResult = jPushClient.createSingleSchedule("西楚推送", time, pushPayload);
     ...
     * @return 0推送失败，1推送成功
     */
    public static int sendToAllByTime(String notification_title, String msg_title, String msg_content, String extrasparam, String time) {
        int result = 0;
        try {
            PushPayload pushPayload = JpushClientUtil.buildPushObject_android_and_ios(notification_title, msg_title, msg_content, extrasparam);
...
//                .setAudience(Audience.registrationId(registrationId))
    ...
    public static PushPayload buildPushObject_android_all_alertWithTitle(String notification_title, String msg_title, String msg_content, String extrasparam) {
        return PushPayload.newBuilder()
                //指定要推送的平台，all代表当前应用配置了的所有平台，也可以传android等具体平台
    ...
    public static PushPayload buildPushObject_ios_all_alertWithTitle(String notification_title, String msg_title, String msg_content, String extrasparam) {
        return PushPayload.newBuilder()
                //指定要推送的平台，all代表当前应用配置了的所有平台，也可以传android等具体平台
